...
var RNEditorWebViewManager = NativeModules.RNEditorWebViewManager;
...
export default class EditorWebView extends React.Component {
    ...
    static propTypes = {
        ...
        /**
         * Loads static html or a uri (with optional headers) in the EditorWebView.
         */
        source: PropTypes.oneOfType([
            PropTypes.shape({
                /*
                 * The URI to load in the `EditorWebView`. Can be a local or remote file.
                 */
            ...
            PropTypes.shape({
                /*
                 * A static HTML page to display in the EditorWebView.
                 */
        ...
        /**
         * Function that is invoked when the `EditorWebView` has finished loading.
         */
        onLoad: PropTypes.func,
        /**
         * Function that is invoked when the `EditorWebView` load succeeds or fails.
         */
        onLoadEnd: PropTypes.func,
        /**
         * Function that is invoked when the `EditorWebView` starts loading.
         */
        onLoadStart: PropTypes.func,
        /**
         * Function that is invoked when the `EditorWebView` load fails.
         */
         ...
         * `EditorWebView`. The default value is `true`.
         * @platform ios
         */
        ...
        /**
         * Function that is invoked when the `EditorWebView` loading starts or ends.
         */
        ...
        /**
         * Boolean value that forces the `EditorWebView` to show the loading view
         * on the first load.
         */
        startInLoadingState: PropTypes.bool,
        /**
         * The style to apply to the `EditorWebView`.
         */
        ...
        /**
         * Boolean value to enable JavaScript in the `EditorWebView`. Used on Android only
        ...
        /**
         * Sets the user-agent for the `EditorWebView`.
         * @platform android
         */

...
#import "RNEditorWebViewManager.h"
...
@implementation RNEditorWebViewManager
{
...
{
  [self.bridge.uiManager addUIBlock:^(__unused RCTUIManager *uiManager, NSDictionary<NSNumber *, RNEditorWebView *> *viewRegistry) {
    RNEditorWebView *view = viewRegistry[reactTag];
    if (![view isKindOfClass:[RNEditorWebView class]]) {
...
- (BOOL)webView:(__unused RNEditorWebView *)webView
